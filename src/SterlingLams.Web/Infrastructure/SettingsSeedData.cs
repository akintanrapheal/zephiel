...
public static class SettingsSeedData
{
    ...
    private static List<SiteSetting> GetAllSettings() => new()
    {
        ...
        new() { Key = "email.from_name",    Group = "Emails", Label = "Sender Name",          Type = "text",     Value = "Glamstar", Description = "Display name on the From line of every email.",            SortOrder = 1 },
        ...
        new() { Key = "home.feature.b1.title",     Group = "Homepage Feature", Label = "Block 1 — Title",        Type = "text",     Value = "",                Description = "Optional heading shown under the image. e.g. \"Knot by Glamstar\".",                                          SortOrder = 3 },
        ...
        new() { Key = "home.feature.b2.title",     Group = "Homepage Feature", Label = "Block 2 — Title",        Type = "text",     Value = "",                Description = "Optional heading shown under the image. e.g. \"HardWear by Glamstar\".",                                      SortOrder = 8 },
        ...
        new() { Key = "email.smtp.from_name",     Group = "SMTP", Label = "From Name",            Type = "text",    Value = "Glamstar", Description = "Sender display name.",                            SortOrder = 6 },
