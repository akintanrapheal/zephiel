...
public static class SettingsSeedData
{
    ...
    {
        // ── General ──────────────────────────────────────────────────────────
        new() { Key = "general.logo_url",         Group = "General", Label = "Site Logo",          Type = "image",   Value = "/images/zephiel-logo.png",                      Description = "Upload your logo (or paste a URL). Shown in the footer. Recommended: transparent PNG.", SortOrder = 0 },
        ...
        new() { Key = "general.site_name",       Group = "General", Label = "Site Name",          Type = "text",    Value = "Zephiel",                                  Description = "Displayed in the browser tab and emails.",    SortOrder = 1 },
        ...
        new() { Key = "general.contact_email",    Group = "General", Label = "Contact Email",      Type = "email",   Value = "info@zephiel.com",                          Description = "Displayed in the footer and contact page.",   SortOrder = 3 },
        ...
        // ── Homepage — Appearance ────────────────────────────────────────────
        new() { Key = "appearance.display_font", Group = "Homepage", Label = "Display font (headings & logo)", Type = "select", Value = "Playfair Display", Description = "The serif used for the ZEPHIEL wordmark and the big headings across the store. Pick one and preview it below, then Save to apply everywhere.", SortOrder = 19 },
        ...
        new() { Key = "home.diamond.color",     Group = "Homepage", Label = "Category diamond — colour",      Type = "color",   Value = "#a855f7", Description = "The gem colour (default is brand pink). Its facets and glow are shaded from this.",  SortOrder = 21 },
        ...
        new() { Key = "general.whatsapp_widget",  Group = "General", Label = "Show WhatsApp chat button", Type = "boolean", Value = "false",                                 Description = "Show the floating WhatsApp button and the 'Ask / Order on WhatsApp' buttons across the storefront. Off by default — turn on to show them everywhere. (Also needs a WhatsApp Number above.)",  SortOrder = 6 },
        new() { Key = "import.nihao_fx_ngn_per_usd", Group = "Import", Label = "Nihao import — ₦ per US$1", Type = "number", Value = "1600", Description = "Exchange rate used when importing Nihaojewelry products: the wholesale US$ price is multiplied by this to get the product cost in Naira.", SortOrder = 1 },
        new() { Key = "import.nihao_markup",         Group = "Import", Label = "Nihao import — retail markup ×", Type = "number", Value = "3", Description = "Suggested retail price on import = cost × this markup (e.g. 3 = 3×). Imported products are drafts, so you can adjust before publishing.", SortOrder = 2 },
        ...
        new() { Key = "announcement.text",        Group = "Announcement Bar", Label = "Announcement Text",      Type = "text",     Value = "COMPLIMENTARY DELIVERY ON ORDERS OVER ₦150,000  |  NATIONWIDE DELIVERY", Description = "Text shown in the top banner. Keep it short.", SortOrder = 2 },
        ...
        // ── Notifications ─────────────────────────────────────────────────────
        new() { Key = "notifications.admin_email",     Group = "Notifications", Label = "Admin Email",                    Type = "email",   Value = "rapheal@zephiellogistics.com", Description = "Receives new order and low stock alerts.",         SortOrder = 1 },
        ...
        new() { Key = "email.from_name",    Group = "Emails", Label = "Sender Name",          Type = "text",     Value = "Zephiel", Description = "Display name on the From line of every email.",            SortOrder = 1 },
        ...
        // ── Homepage ──────────────────────────────────────────────────────────
        new() { Key = "homepage.theme",            Group = "Homepage", Label = "Homepage Theme", Type = "select", Value = "editorial", Description = "The overall look of the homepage. Editorial = refined serif, dark & spacious. Minimal = clean sans, light & airy. Boutique = warm, soft & rounded. Classic = big full-bleed hero, 4 collection tiles, static trust bar, gold accents. All are mobile-optimised.", SortOrder = -1 },
        new() { Key = "homepage.hero_eyebrow",     Group = "Homepage", Label = "Hero Eyebrow (small text above headline)", Type = "text", Value = "New Collection 2026",                          Description = "The small uppercase line above the hero headline (e.g. 'New Collection 2025').", SortOrder = 0 },
        new() { Key = "homepage.hero_headline",    Group = "Homepage", Label = "Hero Headline",          Type = "text",    Value = "Effortless Glamour",                                    Description = "Large text on the homepage hero section.",                              SortOrder = 1 },
        new() { Key = "homepage.hero_subtext",     Group = "Homepage", Label = "Hero Subtext",           Type = "text",    Value = "Jewellery made to be noticed — new-season pieces for the woman who shines.", Description = "Smaller text below the hero headline.", SortOrder = 2 },
        new() { Key = "homepage.hero_cta",         Group = "Homepage", Label = "Hero Button Text",       Type = "text",    Value = "Shop the Collection",                                      Description = "Text on the main call-to-action button.",                               SortOrder = 3 },
        ...
        new() { Key = "homepage.hero_images",      Group = "Homepage", Label = "Hero Campaign Slider Images", Type = "imagelist", Value = "https://images.unsplash.com/photo-1600721391689-2564bb8055de?w=1600&q=80\nhttps://images.unsplash.com/photo-1617038220319-276d3cfab638?w=1600&q=80",                                              Description = "Add multiple campaign photos to make the hero a rotating slider. When set, these replace the single image above. Recommended: full-width landscape, at least 1920×1080px each.", SortOrder = 5 },
        ...
        new() { Key = "homepage.trust_2",          Group = "Homepage", Label = "Trust Bar — Item 2",     Type = "text",   Value = "Free Nationwide Delivery", Description = "Second label in the scrolling pink trust bar.",                SortOrder = 9 },
        new() { Key = "homepage.trust_3",          Group = "Homepage", Label = "Trust Bar — Item 3",     Type = "text",   Value = "Secure Checkout", Description = "Third label in the scrolling pink trust bar.",                 SortOrder = 10 },
        new() { Key = "homepage.trust_4",          Group = "Homepage", Label = "Trust Bar — Item 4",     Type = "text",   Value = "Easy Returns",        Description = "Optional 4th label in the trust bar. Leave blank to hide it.", SortOrder = 11 },
        ...
        new() { Key = "home.feature.b1.title",     Group = "Homepage Feature", Label = "Block 1 — Title",        Type = "text",     Value = "",                Description = "Optional heading shown under the image. e.g. \"Knot by Zephiel\".",                                          SortOrder = 3 },
        ...
        new() { Key = "home.feature.b2.title",     Group = "Homepage Feature", Label = "Block 2 — Title",        Type = "text",     Value = "",                Description = "Optional heading shown under the image. e.g. \"HardWear by Zephiel\".",                                      SortOrder = 8 },
        ...
        new() { Key = "email.smtp.from_address",  Group = "SMTP", Label = "From Address",         Type = "email",   Value = "",      Description = "The address customers see mail come from, e.g. hello@zephiel.com.", SortOrder = 5 },
        new() { Key = "email.smtp.from_name",     Group = "SMTP", Label = "From Name",            Type = "text",    Value = "Zephiel", Description = "Sender display name.",                            SortOrder = 6 },
