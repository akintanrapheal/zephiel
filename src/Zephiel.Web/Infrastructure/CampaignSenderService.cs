...
using Zephiel.Web.Services.Marketing;
...
public class CampaignSenderService : BackgroundService
{
    ...
    private async Task TickAsync(CancellationToken ct)
    {
        ...
        var recsHtml = await Services.Marketing.MarketingService.BestSellerRecsHtmlAsync(
            scope.ServiceProvider.GetRequiredService<Zephiel.Web.Services.IMerchandisingService>(),
            scope.ServiceProvider.GetRequiredService<Zephiel.Web.Services.ISettingsService>(), baseUrl, ct);
