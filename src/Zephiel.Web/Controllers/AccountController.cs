...
public class AccountController : Controller
{
    ...
    private readonly Zephiel.Web.Services.IReferralService _referrals;
    ...
    public AccountController(
        ...
        Zephiel.Web.Services.IReferralService referrals,
    ...
    public async Task<IActionResult> Login(LoginViewModel model)
    {
        ...
        if (result.Succeeded)
        {
            ...
            _logger.LogInformation("User {Email} logged in", Zephiel.Web.Infrastructure.LogRedact.Email(model.Email));
    ...
    public async Task<IActionResult> Register(RegisterViewModel model)
    {
        ...
        if (result.Succeeded)
        {
            _logger.LogInformation("New account created: {Email}", Zephiel.Web.Infrastructure.LogRedact.Email(model.Email));
    ...
    private async Task<IActionResult> UpgradeGuestAsync(ApplicationUser guest, RegisterViewModel model)
    {
        ...
        _logger.LogInformation("Guest account upgraded to a full account: {Email}", Zephiel.Web.Infrastructure.LogRedact.Email(guest.Email));
    ...
    private async Task SendConfirmationEmailAsync(ApplicationUser user)
    {
        ...
        if (_env.IsDevelopment())
            _logger.LogInformation("[DEV] Email confirmation link for {Email}: {Link}", Zephiel.Web.Infrastructure.LogRedact.Email(user.Email), confirmLink);
    ...
    public async Task<IActionResult> ConfirmEmail(string? userId, string? token)
    {
        ...
        if (result.Succeeded)
        {
            _logger.LogInformation("Email confirmed for {Email}", Zephiel.Web.Infrastructure.LogRedact.Email(user.Email));
    ...
    public async Task<IActionResult> ForgotPassword(string email)
    {
        ...
        if (user != null)
        {
            ...
            _logger.LogInformation("Password reset requested for {Email}.", Zephiel.Web.Infrastructure.LogRedact.Email(email));
    ...
    public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
    {
        ...
        if (result.Succeeded)
        {
            _logger.LogInformation("Password reset succeeded for {Email}", Zephiel.Web.Infrastructure.LogRedact.Email(model.Email));
            return RedirectToAction(nameof(ResetPasswordConfirmation));
        }
