...
{
    /// <inheritdoc />
    public partial class LoyaltyFoundation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PointsLedgerEntries_LoyaltyAccounts_LoyaltyAccountId",
                        column: x => x.LoyaltyAccountId,
                        principalTable: "LoyaltyAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PointsLedgerEntries_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointsLedgerEntries_LoyaltyAccountId",
                table: "PointsLedgerEntries",
                column: "LoyaltyAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_PointsLedgerEntries_OrderId",
                table: "PointsLedgerEntries",
                column: "OrderId",
                unique: true,
