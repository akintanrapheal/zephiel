    ...
    public class OrdersController : AdminBaseController
    {
        ...
        private async Task SendPickupReadyEmailAsync(int orderId)
        {
            ...
            var body =
                ...
                + $"<div style=\"text-align:center;margin:0 0 18px\"><a href=\"{passUrl}\" style=\"display:inline-block;background:#a855f7;color:#fff;text-decoration:none;padding:10px 22px;border-radius:8px;font-weight:600\">View pickup pass</a></div>"
