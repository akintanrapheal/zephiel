...
public class FinanceController : AdminBaseController
{
    ...
    private readonly Zephiel.Web.Infrastructure.IFinanceReportService _report;
    public FinanceController(ApplicationDbContext db, Zephiel.Web.Services.ILoyaltyService loyalty,
        Zephiel.Web.Services.ISettingsService settings, Zephiel.Web.Infrastructure.IFinanceReportService report)
    {
        _db = db;
        _loyalty = loyalty;
        _settings = settings;
